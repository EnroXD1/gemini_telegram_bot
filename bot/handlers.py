...
def create_router(
    ...
    async def help_handler(message: Message) -> None:
        ...
        await message.reply(
            ...
            "дней и тихо архивирую медиа. Копию медиа отправляю только после "
            "удаления оригинала. Чтобы сохранить таймерное фото или видео, ответьте "
            "на него любым сообщением до открытия — копия придёт в этот чат с ботом. "
